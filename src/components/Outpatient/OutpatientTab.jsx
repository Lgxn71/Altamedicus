...
const howItWorksData = [
  ...
  },
  {
    ...
    text: "Перед операцией Вам предстоит сдать определенный перечень анализов и пройти ряд исследований. Для удобства все необходимые лабораторно-инструментальные исследования и осмотры врачей-специалистов, Вы можете пройти в Alta Medicus Clinic.",
  },
  {
    id: 3,
