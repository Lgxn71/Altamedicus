    ...
    <section className={styles.actualOffers}>
      <Container>
        <Eyebrow
          ...
          paragraphText="Клиника Alta Medicus заботится о комфорте и удобстве своих пациентов. Мы делаем сервис доступным для каждого!"
        />
...
const offers = [
  ...
  },
  {
    ...
    src: Offer_2,
    text: " В Alta Medicus вы можете проконсультироваться у пластического хирурга по всем видам пластических операций абсолютно бесплатно!",
  },
];
